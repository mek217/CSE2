    ...
    public static void main(String[] arg){
        ...
        for(w=0;w<ragged.length;w++){                                           //Number Row
            for(x=0;x<ragged[w].length;x++){                                    //Number Element
                for(y=x;y<ragged[w].length;y++){                                //Sort
                    smallest=0;
                    for(z=y;z<ragged[w].length;z++){                            //Search row for smallest element
                        if(ragged[w][z]<ragged[w][x]){smallest=z;}
                    }
                    if(ragged[w][y]>ragged[w][smallest]){                       //Swap Number element with smallest element
                        int temp=ragged[w][y];
